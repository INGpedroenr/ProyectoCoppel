<div class="modal fade" id="altaEstablecimientoM" tabindex="-1" role="dialog" aria-labelledby="Alta" aria-hidden="true">
        ...
        <div class="form-group">
            ...
            <label for="correo_electronio">Correo Electronico:</label>
  			...
  			<div>
  					...
  					<a href="{{url('/seleccionarestablecimiento')}}" class="btn btn-danger">Cancelar</a>
  			</div>
  			</input>
  			</form>
        </div>
